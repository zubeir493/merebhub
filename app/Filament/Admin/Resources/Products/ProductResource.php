...
use App\Filament\Admin\Resources\Products\Schemas\ProductWizardForm;
...
class ProductResource extends Resource
{
    ...
    {
        if (($parameters['record'] ?? null) instanceof Product) {
    ...
    {
        return ProductWizardForm::configure($schema);
    }
