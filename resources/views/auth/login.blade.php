...
@section('content')
    <div class="mx-auto max-w-md px-5 py-16">
        ...
        <p class="mt-6 text-center text-sm text-zinc-600">New to MerebHub? <a href="{{ route('register', $authParams) }}" class="font-extrabold text-teal-700">Create an account</a></p>
    </div>
@endsection
