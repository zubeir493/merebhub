...
<section class="mh-empty">
    <?php echo merebhub_icon('shopping-cart'); ?>
    ...
    <?php } else { ?>
        ...
        <?php if (wc_get_page_id('shop') > 0) { ?><a class="button" href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"><?php esc_html_e('Browse software', 'merebhub'); ?></a><?php } ?>
    <?php } ?>
</section>
