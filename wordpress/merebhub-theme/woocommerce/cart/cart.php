    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
        ...
        <?php foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
            ...
            <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                ...
                <td class="product-thumbnail"><?php $thumbnail = apply_filters('woocommerce_cart_item_thumbnail', $_product->get_image('thumbnail'), $cart_item, $cart_item_key);
            echo $product_permalink ? sprintf('<a href="%s">%s</a>', esc_url($product_permalink), $thumbnail) : $thumbnail; ?></td>
                <td class="product-name" data-title="<?php esc_attr_e('Software', 'merebhub'); ?>"><?php echo $product_permalink ? wp_kses_post(sprintf('<a href="%s">%s</a>', esc_url($product_permalink), $_product->get_name())) : wp_kses_post($_product->get_name());
            do_action('woocommerce_after_cart_item_name', $cart_item, $cart_item_key);
            echo wc_get_formatted_cart_item_data($cart_item); ?></td>
                ...
                <td class="product-quantity" data-title="<?php esc_attr_e('Seats', 'merebhub'); ?>">
                    <div class="mh-quantity-control">
                        <button type="button" data-mh-quantity="decrease" aria-label="<?php esc_attr_e('Decrease seats', 'merebhub'); ?>"><?php echo merebhub_icon('minus'); ?></button>
                        ...
                        <button type="button" data-mh-quantity="increase" aria-label="<?php esc_attr_e('Increase seats', 'merebhub'); ?>"><?php echo merebhub_icon('plus'); ?></button>
                    </div>
                </td>
